...
func init() {
	...
	file3 := &embedded.EmbeddedFile{
		Filename:    "issuer-letsencrypt.yml",
	...
	dir1 := &embedded.EmbeddedDir{
		Filename:   "",
		DirModTime: time.Unix(1531374057, 0),
		ChildFiles: []*embedded.EmbeddedFile{
			file2, // "Chart.yaml"
			file3, // "issuer-letsencrypt.yml"
			file4, // "requirements.yaml"
			file5, // "secret-ingress-auth-prometheus.yml"
			file6, // "values.yml"
	...
	embedded.RegisterEmbeddedBox(`templates`, &embedded.EmbeddedBox{
		Name: `templates`,
		Time: time.Unix(1531374057, 0),
		Dirs: map[string]*embedded.EmbeddedDir{
			"": dir1,
		},
		Files: map[string]*embedded.EmbeddedFile{
			"Chart.yaml":                         file2,
			"issuer-letsencrypt.yml":             file3,
			"requirements.yaml":                  file4,
			"secret-ingress-auth-prometheus.yml": file5,
			"values.yml":                         file6,
		},
	})
}
